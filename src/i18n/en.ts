...
const en: Translation = {
  ...
  hero: {
    ...
    badges: [
      { initials: 'MK', quote: 'They won a case two other firms had declined.', role: 'Managing Director' },
      { initials: 'AR', quote: 'Precise, fast and utterly trustworthy.', role: 'CEO, FinTech' },
    ],
  },
  statement: {
    segments: [
  ...
  scrollBadge: 'SCROLL TO EXPLORE · BOOK A CONSULTATION · SCROLL TO EXPLORE · BOOK A CONSULTATION ·',
  imageSection: {
    caption: 'Counsel you can trust — in the boardroom and in the courtroom.',
  },
  footer: {
    tagline: 'Smart legal solutions, delivered with integrity. Your legal partner in every situation.',
    columns: [
      { heading: 'Practice Areas', links: ['Corporate Law', 'Litigation', 'Mergers & Acquisitions', 'Family Law', 'Tax Law'] },
      { heading: 'Firm', links: ['About', 'Case Studies', 'Our Team', 'Careers'] },
      { heading: 'Contact', links: ['Book a Consultation', 'Madrid Office', 'Miami Office', 'hello@lexcore.law'] },
    ],
  ...
  about: {
    ...
    values: [
      { title: 'Integrity', text: 'We tell you what you need to hear, not what you want to hear.' },
      { title: 'Precision', text: 'Every document, argument and deadline treated as decisive.' },
      { title: 'Discretion', text: 'The matters we handle stay in the room. Always.' },
      { title: 'Results', text: 'Strategy measured by outcomes, not billable hours.' },
    ],
    stats: [
      { value: '18+', label: 'Years in Practice' },
      { value: '100+', label: 'Legal Matters Resolved' },
  ...
  services: {
    ...
    items: [
      { index: '01', title: 'Corporate Law', text: 'Company formation, governance, shareholder agreements and ongoing counsel for boards and founders.' },
      { index: '02', title: 'Litigation & Arbitration', text: 'High-stakes dispute resolution in national courts and international arbitral tribunals.' },
      { index: '03', title: 'Mergers & Acquisitions', text: 'End-to-end deal support: due diligence, negotiation, structuring and closing.' },
      { index: '04', title: 'Family Law', text: 'Divorce, custody and inheritance matters handled with firmness and discretion.' },
      { index: '05', title: 'Tax Law', text: 'International structuring, controversy and compliance for individuals and companies.' },
      { index: '06', title: 'Regulatory & Investigations', text: 'Defence and remediation in regulatory investigations, including cross-border matters.' },
    ],
    cta: 'Discuss your matter with us ↗',
  },
  caseStudy: {
    title: 'Case Studies',
    intro: 'A selection of matters our clients have asked us to share. Names and sensitive details are redacted by design.',
    cases: [
      {
      ...
      },
      {
        ...
        solution: 'A treaty-based restructuring migrated the portfolio into a neutral, compliant holding structure.',
